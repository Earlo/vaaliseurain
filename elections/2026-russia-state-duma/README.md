...
Telegram, RBC's election RSS item, Public Chamber data and AFP metadata are
refreshed automatically; inaccessible or browser-only sources retain explicit
manual status and cached values.
