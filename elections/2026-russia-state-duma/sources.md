...
Research snapshot: **19 September 2026, 17:38 EEST (UTC+3)**. Re-check all live
...
| [CEC Telegram](https://t.me/s/cikrossii) | Timestamped official turnout, incident, schedule, and result posts | 4 | 4 | Minutes | 3 | Best official fallback when CEC web pages are slow. Link/filter `#Госдума9` and `#ЕДГ2026`; avoid depending on undocumented HTML selectors. |
...
| [RBC Duma election topic](https://www.rbc.ru/story/57d3fbaa9a794798429622f7) and [rolling explainer](https://www.rbc.ru/politics/18/09/2026/6aa940649a7947803fdcc142) | Fast mainstream Russian news, CEC figures, incidents, and links to primary data | 4 | 3 | Minutes | 2 | Use as the mainstream news rail. Prefer headline/link/time metadata over copying article text. |
| [Novaya Gazeta Europe election live page](https://novayagazeta.eu/elections2026/online) | Independent live reporting, incidents, and critical context | 4 | 4 | Minutes | 2 | Use as one critical live rail; open externally if no licensed feed is available. |
...
| [Public Chamber election monitoring](https://monitoring.oprf.ru/) | Official-aligned observer statistics, hotline activity, reports, and embedded video | 3 | 4 | Near-real time | 4 | Add as a counterpoint to independent incident reporting. The page labels its material CC BY 4.0. |
...
| RBC | Returned HTTP 401 to a plain automated request | Treat automated ingestion as unavailable unless RBC exposes a supported feed. Link out or update manually. |
...
| CEC Telegram public web view | HTTP 200, with `X-Frame-Options: SAMEORIGIN` | Direct framing is blocked. Server-side extraction of a small amount of metadata is technically possible but selector-fragile. |
| Public Chamber monitor | Publicly readable and marked CC BY 4.0 | Best current candidate for an automated incident/monitoring adapter, subject to checking attribution and endpoint stability. |
...
- A current Golos/independent violation-map endpoint specific to this election
  was not found reliably enough to recommend. It should not be guessed into the
  dashboard.
